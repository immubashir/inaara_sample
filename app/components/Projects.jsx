    ...
    <div className='h-[140vh] px-20 relative'>
        <div>
            ...
            <div className='flex flex-col mt-20 gap-28'>
                ...
                <div className='flex gap-10 p-8 rounded-xl border-slate-500 hover:bg-slate-500/10 transition-all duration-300 items-center group'>
                    <Image src="/Dribbble_Divi_img.jpg" height={200} width={400} className='object-cover rounded-3xl absolute scale-[0.2] group-hover:scale-100 right-20 group-hover:translate-x-0 translate-x-12 transition-all duration-500'/>
                    <div className='flex flex-col text-center'>
